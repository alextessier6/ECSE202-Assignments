//
//  Assignment 6 ECSE-202 - Eval Class
...
public class Eval {
	...
	double arg1 = Double.parseDouble(a); //The string a is converted to a double for the calculations to work
	double arg2 = Double.parseDouble(b); //The string b is converted to a double for the calculations to work
	
	double answ=0;        // A double answ will store the resulting value of the mathematical operation
	...
	return String.valueOf(answ); //The double answ is converted back to a string for it to be pushed later in a stack that only accepts strings.
	}
}
